...
<body>
    ...
    <main>
        ...
        <form action = './ghStdp3.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ghEditp3.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ghdelp3.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 3
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'ghp3.php'>
