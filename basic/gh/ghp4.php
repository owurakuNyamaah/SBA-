...
<body>
    ...
    <main>
        ...
        <form action = './ghStdp4.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ghEditp4.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ghdelp4.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 4
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'ghp4.php'>
