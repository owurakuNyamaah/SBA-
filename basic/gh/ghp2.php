...
<body>
    ...
    <main>
        ...
        <form action = './ghStdp2.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ghEditp2.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ghdelp2.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 2
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'ghp2.php'>
