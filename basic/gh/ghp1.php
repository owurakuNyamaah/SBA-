...
<body>
    ...
    <main>
        ...
        <form action = './ghStdp1.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ghEditp1.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ghdelp1.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 1
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'ghp1.php'>
