...
<body>
    <?php 
        ...
        include('../server/gh/edit6.php');
     
    ?>
    <header>
    <h2>Edit Student Details - Ghanaian Language</h2>
        <form action = './ghp6.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'ghEditp6.php' class = 'container'>
