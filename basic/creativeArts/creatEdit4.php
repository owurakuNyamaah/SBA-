...
<?php 
        ...
        include('../server/creativeArts/edit4.php'); 
    ?>

    <header>
        <h2>Edit Student Details - Creative Arts</h2>
        <form action = './creative4.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'creatEdit4.php' class = 'container'>
