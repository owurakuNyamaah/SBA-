...
<?php 
        ...
        include('../server/creativeArts/edit5.php'); 
    ?>

    <header>
        <h2>Edit Student Details - Creative Arts</h2>
        <form action = './creative5.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'creatEdit5.php' class = 'container'>
