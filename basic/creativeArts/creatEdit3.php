...
<?php 
        ...
        include('../server/creativeArts/edit3.php'); 
    ?>

    <header>
        <h2>Edit Student Details - Creative Arts</h2>
        <form action = './creative3.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'creatEdit3.php' class = 'container'>
