...
<?php 
        ...
        include('../server/creativeArts/edit2.php'); 
    ?>

    <header>
        <h2>Edit Student Details - Creative Arts</h2>
        <form action = './creative2.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'creatEdit2.php' class = 'container'>
