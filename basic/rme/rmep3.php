...
<body>
    ...
    <main>
        ...
        <form action = './rmeStdp3.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './rmeEditp3.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./rmedelp3.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 3
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'rmep3.php'>
