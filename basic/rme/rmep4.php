...
<body>
    ...
    <main>
        ...
        <form action = './rmeStdp4.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './rmeEditp4.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./rmedelp4.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 4
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'rmep4.php'>
