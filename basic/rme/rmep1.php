...
<body>
    ...
    <main>
        ...
        <form action = './rmeStdp1.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './rmeEditp1.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./rmedelp1.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 1
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'rmep1.php'>
