...
<body>
    ...
    <main>
        ...
        <form action = './rmeStdp2.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './rmeEditp2.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./rmedelp2.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 2
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'rmep2.php'>
