...
<body>
    ...
    <main>
        <h1>French SBA</h1>
        <form action = './freStdp1.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './freEditp1.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./fredelp1.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 1
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'frep1.php'>
