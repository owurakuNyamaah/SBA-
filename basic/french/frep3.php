...
<body>
    ...
    <main>
        <h1>French SBA</h1>
        <form action = './freStdp3.php'><button class = 'std'>ADD student</button></form>
        <form action = './freEditp3.php'><button class = 'edit'>Edit</button></form>
        <form action='./fredelp3.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 3
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'frep3.php'>
