...
<head>
    ...
    <title>French Student form</title>
...
<body>
    <header>
        <h2>P2 Student Assesment Details</h2>
        <form action = 'frep2.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'freStdp2.php' class = 'container'>
