...
<body>
    ...
    <main>
        <h1>French SBA</h1>
        <form action = './freStdp6.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './freEditp6.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./fredelp6.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 6
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'frep6.php'>
        ...
        <div style = 'overflow-x:auto'>
            ...
            include('../server/french/Serv6.php');
