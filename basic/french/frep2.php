...
<body>
    ...
    <main>
        <h1>French SBA</h1>
        <form action = './freStdp2.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './freEditp2.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./fredelp2.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 2
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'frep2.php'>
