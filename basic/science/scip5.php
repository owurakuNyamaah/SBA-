...
<body>
    ...
    <main>
        ...
        <form action = './sciStdp5.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './sciEditp5.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./scidelp5.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 5
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'scip5.php'>
        ...
        <div style = 'overflow-x:auto'>
            ...
            include('../server/science/Serv5.php');
