...
<body>
    ...
    <main>
        ...
        <form action = './sciStdp3.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './sciEditp3.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./scidelp3.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 3
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'scip3.php'>
        ...
        <div style = 'overflow-x:auto'>
            ...
            include('../server/science/Serv3.php');
