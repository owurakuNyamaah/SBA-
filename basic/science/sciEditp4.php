...
<body>
    <?php 
        ...
        include('../server/science/edit4.php');
    ?>

    <header>
    <h2>Edit Student Details - Science</h2>
        <form action = './scip4.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'sciEditp4.php' class = 'container'>
