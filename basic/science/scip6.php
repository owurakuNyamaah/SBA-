...
<body>
    ...
    <main>
        ...
        <form action = './sciStdp6.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './sciEditp6.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./scidelp6.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 6
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'scip6.php'>
        ...
        <div style = 'overflow-x:auto'>
            ...
            include('../server/science/Serv6.php');
