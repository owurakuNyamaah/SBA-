...
<body>
    ...
    <main>
        ...
        <form action = './sciStdp2.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './sciEditp2.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./scidelp2.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 2
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'scip2.php'>
        ...
        <div style = 'overflow-x:auto'>
            ...
            include('../server/science/Serv2.php');
