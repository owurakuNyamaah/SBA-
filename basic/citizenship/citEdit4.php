...
<head>
    ...
    <title>P4 Citizenship Edit</title>
...
<?php 
        ...
        include('../server/citizenship/edit4.php');

    ?>

    <header>
        <h2>Edit Student Details - Citizenship</h2>
        <form action = './citizen4.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'citEdit4.php' class = 'container'>
