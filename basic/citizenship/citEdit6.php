...
<?php 
        ...
        include('../server/citizenship/edit6.php');
    ?>

    <header>
    <h2>Edit Student Details - Citizenship</h2>
        <form action = './citizen6.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'citEdit6.php' class = 'container'>
