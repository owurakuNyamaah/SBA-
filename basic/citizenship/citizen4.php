...
<head>
    ...
    <title>P4 Citizenship SBA</title>
...
<body>
    ...
    <main>
        ...
        <form action = './citStd4.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './citEdit4.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./citdel4.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 4
            <span>
               <?php 
                    $connect = mysqli_connect('localhost','root','','p4sba');
                    $sql = "SELECT COUNT(student_name) AS numStd FROM citizen";
            ...
            <span>
                <?php 
                    $sql = "SELECT ROUND(AVG(total_100),3) AS average FROM citizen";
                    $result = mysqli_query($connect, $sql);
                    while($row=mysqli_fetch_assoc($result)) {
            ...
            <span>
                <form method = 'post' action = 'citizen4.php'>
