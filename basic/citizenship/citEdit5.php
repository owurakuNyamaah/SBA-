...
<head>
    ...
    <title>P6 Citizenship Edit</title>
...
<?php 
        ...
        include('../server/citizenship/edit5.php');
    ?>

    <header>
    <h2>Edit Student Details - Citizenship</h2>
        <form action = './citizen5.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'citEdit5.php' class = 'container'>
