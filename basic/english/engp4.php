...
<body>
    ...
    <main>
        ...
        <form action = './engStdp4.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action='engEditp4.php'><button class= 'edit'>Edit</button></form> -->
        <form action='./engdelp4.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 4
            <span>
            <?php
        ...
        <span>
                <form method = 'post' action = 'engp4.php'>
        ...
        <div style = 'overflow-x:auto'>
            <?php 
                include('../server/english/Serv4.php');
        ?>
        </div>
    </main>
