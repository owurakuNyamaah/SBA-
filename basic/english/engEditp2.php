...
<?php 
        ...
        include('../server/english/edit2.php');
        
    ?>

    <header>
    <h2>Edit Student Details - English</h2>
        <form action = './engp2.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'engEditp2.php' class = 'container'>
