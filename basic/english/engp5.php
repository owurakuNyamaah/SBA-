...
<body>
    ...
    <main>
        ...
        <form action = './engStdp5.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action='engEditp5.php'><button class= 'edit'>Edit</button></form> -->
        <form action='./engdelp5.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 5
            <span>
            <?php
        ...
        <span>
                <form method = 'post' action = 'engp5.php'>
        ...
        <div style = 'overflow-x:auto'>
            <?php 
                include('../server/english/Serv5.php');
        ?>
        </div>
    </main>
