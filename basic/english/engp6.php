...
<body>
    ...
    <main>
        ...
        <form action = './engStdp6.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action='engEditp6.php'><button class= 'edit'>Edit</button></form> -->
        <form action='./engdelp6.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 6
            <span>
            <?php
        ...
        <span>
                <form method = 'post' action = 'engp6.php'>
        ...
        <div style = 'overflow-x:auto'>
            <?php 
                include('../server/english/Serv6.php');
        ?>
        </div>
    </main>
