...
<body>
    ...
    <main>
        ...
        <form action = './ictStdp5.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ictEditp5.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ictdelp5.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 5
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'ictp5.php'>
