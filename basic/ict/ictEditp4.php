...
<body>
    <?php 
        ...
        include('../server/ict/edit4.php');
    ?>

    <header>
    <h2>Edit Student Details - ICT</h2>
        <form action = './ictp4.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'ictEditp4.php' class = 'container'>
