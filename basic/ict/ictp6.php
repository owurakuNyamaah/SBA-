...
<body>
    ...
    <main>
        ...
        <form action = './ictStdp6.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ictEditp6.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ictdelp6.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 6
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'ictp6.php'>
