...
<?php 
        ...
        include('../server/maths/edit.php');    
    ?>

    <header>
        <h2>Edit Student Details - Maths</h2>
        <form action = './mathsp1.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'mathsEditp1.php' class = 'container'>
