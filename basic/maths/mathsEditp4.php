...
<?php 
        ...
        include('../server/maths/edit4.php');    
    ?>

    <header>
    <h2>Edit Student Details - Maths</h2>
        <form action = './mathsp4.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'mathsEditp4.php' class = 'container'>
