...
<?php 
        ...
        include('../server/maths/edit2.php');    
    ?>

    <header>
    <h2>Edit Student Details - Maths</h2>
        <form action = './mathsp2.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'mathsEditp2.php' class = 'container'>
