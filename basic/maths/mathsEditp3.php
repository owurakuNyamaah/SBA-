...
<?php 
        ...
        include('../server/maths/edit3.php');    
    ?>

    <header>
    <h2>Edit Student Details - Maths</h2>
        <form action = './mathsp3.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'mathsEditp3.php' class = 'container'>
