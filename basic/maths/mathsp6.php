...
<body>
    ...
    <main>
        ...
        <form action = './mathStdp6.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './mathsEditp6.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./mathdelp6.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 6
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'mathsp6.php'>
        ...
        <div style = 'overflow-x:auto'>
            <?php 
                include('../server/maths/Serv6.php');
