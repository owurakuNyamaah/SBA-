...
<?php 
        ...
        include('../server/maths/edit5.php');    
    ?>

    <header>
    <h2>Edit Student Details - Maths</h2>
        <form action = './mathsp5.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'mathsEditp5.php' class = 'container'>
