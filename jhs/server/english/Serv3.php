                    ...
                    if(mysqli_num_rows($result) > 0 ) {
                        ...
                        echo  "</td>
                                <td>$row[student_name]</td>
                                    ...
                                    <td>
                                    <button class='edit'>
                                    <a href = './engEdit3.php?StdName=$row[student_name]&indTest=$row[individual_test]&classTest=$row[class_test]&groupWork=$row[group_work]&project=$row[project]&exams=$row[exams]' style='text-decoration:none;color:white'>Edit</a>
                                    </button>
                                    </td>        
                                </tr>";
                        }
