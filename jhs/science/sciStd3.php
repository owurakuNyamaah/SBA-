...
<head>
    ...
    <title>Science Student form</title>
...
<body>
    <header>
        ...
        <form action = './science3.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'sciStd3.php' class = 'container'>
