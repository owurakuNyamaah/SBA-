...
<body>
    ...
    <main>
        ...
        <form action = './socStd2.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './socEdit2.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./socdel2.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = JHS 2
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'social2.php'>
        ...
        <div style='overflow-x:auto'>
                <?php 
                include('../server/social/Serv2.php');
