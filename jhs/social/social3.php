...
<body>
    ...
    <main>
        ...
        <form action = './socStd3.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './socEdit3.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./socdel3.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = JHS 3
            <span>
               <?php 
        ...
        <div style='overflow-x:auto'>
                <?php 
                include('../server/social/Serv3.php');
