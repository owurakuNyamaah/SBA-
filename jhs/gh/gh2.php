...
<body>
    ...
    <main>
        ...
        <form action = './ghStd2.php'><button class = 'std'>ADD student</button></form>
        <!-- <form action = './ghEdit2.php'><button class = 'edit'>Edit</button></form> -->
        <form action='./ghdel2.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = JHS 2
            <span>
               <?php 
            ...
            <span>
                <form method = 'post' action = 'gh2.php'>
