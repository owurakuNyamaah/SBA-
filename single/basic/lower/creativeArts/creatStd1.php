...
<head>
    ...
    <title>Creative Arts Student </title>
...
<body>
    <header>
       <h2>Student Assesment Details</h2>
        <form action = './creative1.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'creatStd1.php' class = 'container'>
        <label>Student Name</label><br>
        <input name='stdName' type= 'text' placeholder = 'Enter Full Name' requiredS/><br>
