...
<body>
    ...
    <main>
        ...
        <p>Student Based Assessment is an integral part of academia because it enables teachers to record and rank the 
            performance of their students. This web application is designed to assist teachers to record class exercise
            and exams scores, rank the terminal positions and also automatically create terminal reports of their 
            students with ease and efficiently.
        </p>
        <div>
