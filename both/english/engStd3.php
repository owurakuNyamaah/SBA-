...
<head>
    ...
    <title>English Student form</title>
...
<body>
    <header>
        ...
        <form action = './english3.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'engStd3.php' class = 'container'>
