<?php
    ...
    WHERE
        (
            eng.total_100 + science.total_100 + maths.total_100 + arts.total_100 + rme.total_100 + ict.total_100 + 
            gh.total_100 + french.total_100 + citizen.total_100
        ) =(
        SELECT
            MAX(
                eng.total_100 + science.total_100 + maths.total_100 + arts.total_100 + rme.total_100 + ict.total_100 + 
...
?>
    ...
    <div class='perform'>
        ...
        <ul>
        <?php 
        $sql1 = "SELECT ROUND(MAX(exams),1) AS exams FROM arts";
        $result1 = mysqli_query($connect, $sql1); 
        echo "<li>Exams Highest score = "; while($row=mysqli_fetch_assoc($result1)){echo $row['exams'];}
        echo "</li>";

        $sql2 = "SELECT ROUND(MIN(exams),1) AS exams FROM arts";
        $result2 = mysqli_query($connect, $sql2); 
        echo "<li>Exams Lowest score = "; while($row=mysqli_fetch_assoc($result2)){echo $row['exams'];}
        echo "</li>";
        ...
        $sql5 = "SELECT student_name FROM arts WHERE total_100 = (SELECT MAX(total_100) FROM arts)  ";
        $result5 = mysqli_query($connect, $sql5); 
        echo "<li>Best Student is "; while($row=mysqli_fetch_assoc($result5)){echo $row['student_name'];}
        echo "</li>";
        ?>
        ...
        <ul>
        <?php 
        $sql1 = "SELECT ROUND(MAX(exams),1) AS exams FROM citizen";
        $result1 = mysqli_query($connect, $sql1); 
        echo "<li>Exams Highest score = "; while($row=mysqli_fetch_assoc($result1)){echo $row['exams'];}
        echo "</li>";

        $sql2 = "SELECT ROUND(MIN(exams),1) AS exams FROM citizen";
        $result2 = mysqli_query($connect, $sql2); 
        echo "<li>Exams Lowest score = "; while($row=mysqli_fetch_assoc($result2)){echo $row['exams'];}
        echo "</li>";

        $sql3 = "SELECT COUNT(total_100) AS pass FROM citizen WHERE total_100 >= 35 ";
        $result3 = mysqli_query($connect, $sql3); 
        echo "<li>Number of students who passed = "; while($row=mysqli_fetch_assoc($result3)){echo $row['pass'];}
        echo "</li>";

        $sql4 = "SELECT COUNT(total_100) AS failed FROM citizen WHERE total_100 <= 35 ";
        $result4 = mysqli_query($connect, $sql4); 
        echo "<li>Number of students who failed = "; while($row=mysqli_fetch_assoc($result4)){echo $row['failed'];}
        echo "</li>";

        $sql5 = "SELECT student_name FROM citizen WHERE total_100 = (SELECT MAX(total_100) FROM citizen)  ";
        $result5 = mysqli_query($connect, $sql5); 
        echo "<li>Best Student is "; while($row=mysqli_fetch_assoc($result5)){echo $row['student_name'];}
        echo "</li>";
        ?>
        ...
        $sql2 = "SELECT ROUND(MIN(exams),1) AS exams FROM ict";
        $result2 = mysqli_query($connect, $sql2); 
        echo "<li>Exams Lowest score = "; while($row=mysqli_fetch_assoc($result2)){echo $row['exams'];}
        echo "</li>";

        $sql3 = "SELECT COUNT(total_100) AS pass FROM ict WHERE total_100 >= 35 ";
        $result3 = mysqli_query($connect, $sql3); 
        echo "<li>Number of students who passed = "; while($row=mysqli_fetch_assoc($result3)){echo $row['pass'];}
        echo "</li>";
