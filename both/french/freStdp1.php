...
<head>
    ...
    <title>P1 French Student form</title>
...
<body>
    <header>
        ...
        <form action = 'frep1.php'><button class = 'std'>Return to SBA</button></form>
    </header>

    <form method = 'post' action = 'freStdp1.php' class = 'container'>
