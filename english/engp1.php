...
<body>
    ...
    <main>
        ...
        <form action = './engStdp1.php'><button class = 'std'>ADD student</button></form>
        <form action='engEditp1.php'><button class= 'edit'>Edit</button></form>
        <form action='./engdelp1.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = P 1
            <span>
            <?php
