...
<body>
    ...
    <main>
        ...
        <form action = './engStd3.php'><button class = 'std'>ADD student</button></form>
        <form action='engEdit3.php'><button class= 'edit'>Edit</button></form>
        <form action='./engdel3.php'><button class = 'del'>Delete</button></form>
        <div class = 'count'>
        Class = JHS 3
            <span>
            <?php
        ...
        <span>
                <form method = 'post' action = 'english3.php'>
